...
#   4. Assigns Contributor role on the registry resource group
#   5. Sets GitHub repository secrets
###############################################################################

GITHUB_ORG="launchcg"
GITHUB_REPO="nexus-template"
APP_NAME="dex-registry-github-actions"
...
echo "============================================"
echo ""
echo "GitHub Actions will now authenticate via OIDC on push to main."
